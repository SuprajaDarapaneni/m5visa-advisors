          ...
          <div className="bg-brand rounded-[3rem] p-12 lg:p-20 text-center relative overflow-hidden">
            <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                    <a 
                      href="https://wa.me/918333075544?text=I%20would%20like%20to%20book%20a%20free%20consultation%20slot." 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="bg-brand text-white px-10 py-4 rounded-full font-bold text-lg text-center shadow-2xl shadow-brand/20 hover:scale-105 transition-transform"
                    >
                      Book Free Slot
                    </a>
                    <a 
                      href="tel:+919515354865" 
                      className="bg-white/10 text-white border border-white/20 px-10 py-4 rounded-full font-bold text-lg backdrop-blur-md text-center hover:bg-white/20 transition-all"
                    >
                      Call Now
                    </a>
                </div>
